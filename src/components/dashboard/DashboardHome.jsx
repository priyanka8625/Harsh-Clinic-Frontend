...
const DashboardHome = () => {
  ...
  const fetchData = async (option) => {
    try {
      const response = await axios.get(`https://harsh-2onb.onrender.com/${option}/all`,{
  ...
  const fetchCounts = async () => {
    try {
      const opdResponse = await axios.get('http://harsh-2onb.onrender.com/opd/all',{
        withCredentials: true,
      });
      const ipdResponse = await axios.get('http://harsh-2onb.onrender.com/ipd/all',{
        withCredentials: true,
      });
      const patientResponse = await axios.get('http://harsh-2onb.onrender.com/patient/all',{
        withCredentials: true,
      });
      const itemResponse=await axios.get('http://harsh-2onb.onrender.com/item/all',{
        withCredentials: true,
      });
